...
// macOS screenshot
#define MAC_SS LSFT(LGUI(KC_4))

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // macOS layer
    [0] = LAYOUT_tkl_ansi(
        KC_ESC,  KC_BRID, KC_BRIU, KC_MCTL, KC_LPAD, RGB_VAD,  RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_DEL,  MAC_SS,  KC_MUTE,
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,  KC_K42,   KC_ENT,  KC_PGDN,
    ...
    [1] = LAYOUT_tkl_ansi(
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,  KC_K42,   KC_ENT,  KC_PGDN,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                              KC_RCTL, MO(3),              KC_LEFT,  KC_DOWN, KC_RGHT
    ),
    // macOS function layer
    [2] = LAYOUT_tkl_ansi(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   RGB_TOG, MAC_SS,  KC_MUTE,
        ...
        KC_CAPS, TO(0),   TO(1),   KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    LOGO_SAD, LOGO_SAI, RGB_MOD,  RGB_HUI, RGB_SAD,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    SIX_N,   KC_M,    KC_COMM, KC_DOT,   KC_SLSH,  LOGO_HUI, RGB_VAI,
        TEST_CL, QK_WLO,  KC_LGUI,                   LOGO_MOD,                            KC_RGUI, KC_NO,              RGB_SPD,  RGB_VAD, RGB_SPI
    ),
    // win/linux function layer
    [3] = LAYOUT_tkl_ansi(
        ...
        KC_CAPS, TO(0),   TO(1),   KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    LOGO_SAD, LOGO_SAI, RGB_MOD,  RGB_HUI, RGB_SAD,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    SIX_N,   KC_M,    KC_COMM, KC_DOT,   KC_SLSH,  LOGO_HUI, RGB_VAI,
        TEST_CL, QK_WLO,  KC_LALT,                   LOGO_MOD,                            KC_RCTL, KC_NO,              RGB_SPD,  RGB_VAD, RGB_SPI
    )
};
